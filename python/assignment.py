...
def calculate_subtotal(order):
    ...
    subtotal = 0.0  # Initialize the subtotal to zero
    for item in order:
        subtotal += item['price']  # Add the price of each item to subtotal
...
def summarize_order(order):
    ...
    total = round(subtotal + tax, 2)  # Calculate total and round to two decimal places
    
    # Get the names of the items in the order
...
def main():
    ...
    print("Order summary: Items:", items, "Total: $" + str(total))
