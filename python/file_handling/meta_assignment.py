...
def main():
    ...
    print(read_file_into_list(file_contents))
    write_first_line_to_file('sampletext', "online.txt")
    print(read_even_numbered_lines(file_contents))
    print(read_file_in_reverse(file_contents))
